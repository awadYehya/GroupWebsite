...
quiz.onFirstQuestion = function () {
    ...
    nextQuizButton.innerHTML = "NEXT";
    nextQuizButton.classList.add("button");
    nextQuizButton.classList.remove("button-primary");
};
...
quiz.onLastQuestion = function () {
    prevQuizButton.disabled = false;
    nextQuizButton.innerHTML = "SUBMISSION";
    nextQuizButton.classList.remove("button");
    nextQuizButton.classList.add("button-primary");
};
